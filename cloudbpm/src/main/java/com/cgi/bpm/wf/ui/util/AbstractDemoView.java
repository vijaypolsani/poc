package com.cgi.bpm.wf.ui.util;
...
public abstract class AbstractDemoView<V extends ControllableView, P extends ControllablePresenter<V>>
	...
	public AbstractDemoView(boolean init) {
		super(init);
	}
