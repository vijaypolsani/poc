...
public class LoginViewImpl extends AbstractView<LoginView, LoginPresenter>
	...
	public String getDisplayName() {
		return "Cloud BPM Application Login";
	}
	...
	protected void initView() {
		...
		Label header = new Label("Login to Cloud BPM");
		//header.addStyleName(Reindeer.LABEL_H1);
		header.addStyleName(ChameleonTheme.LABEL_H1);
		loginPanel.addComponent(header);

		username = new TextField("Username");
		username.setWidth("100%");
		username.addStyleName(ChameleonTheme.LABEL_H2);
		...
		viewLayout.addStyleName(ChameleonTheme.ACCORDION_OPAQUE);
