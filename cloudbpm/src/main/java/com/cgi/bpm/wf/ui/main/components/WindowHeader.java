package com.cgi.bpm.wf.ui.main.components;

import com.cgi.bpm.wf.ui.main.MainPresenter;
...
public class WindowHeader extends HorizontalLayout implements RefreshListener {
	...
	public WindowHeader(MainPresenter mainPresenter) {
		...
		setMargin(true);
		setSpacing(true);
		addStyleName(ChameleonTheme.ACCORDION_OPAQUE);
	...
	private VerticalLayout createTitle() {
		...
		Label appTitle = new Label("Cloud BPM Application");
		appTitle.addStyleName(ChameleonTheme.LABEL_H1);
	...
	private Button createMyTasksButton() {
		...
		button.addStyleName(ChameleonTheme.BUTTON_SMALL);
		return button;
	}
